...
def plot(nodes, norm_x=100, norm_y=100, color=None, label=None, value=None, ax=None, pad=False, bar_kwargs=None, text_kwargs=None, **kwargs):
    ...
    if color is None:
        ...
        color = [cmap(random.random()) for i in range(len(nodes))]
    ...
    sizes = [node.value for node in nodes.children]
